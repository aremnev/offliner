...
class Domain implements \JsonSerializable {
     ...
     * @var IndexerUser
     *
     * @ORM\ManyToOne(targetEntity="IndexerUser", inversedBy="domains") //TODO: class name from config
     ...
     * Set user
     *
     * @param IndexerUser $user
     * @return Domain
     */
    public function setUser(IndexerUser $user = null) {
        $this->user = $user;
